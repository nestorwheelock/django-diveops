package com.diveops.chat.location
...
import com.diveops.chat.DiveOpsApp
import com.diveops.chat.MainActivity
...
class LocationTrackingService : Service() {
    ...
    override fun onCreate() {
        ...
        locationRepository = LocationRepository(DiveOpsApp.getInstance().authRepository)
