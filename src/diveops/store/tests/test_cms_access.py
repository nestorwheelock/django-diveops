...
from diveops.operations.entitlements.services import grant_entitlements
from diveops.operations.entitlements.cms_checker import cms_entitlement_checker
...
def cms_settings(db):
    ...
    settings.entitlement_checker_path = (
        "diveops.operations.entitlements.cms_checker.cms_entitlement_checker"
    )
    settings.save()
    return settings
